			...
			await axios.
                delete('https://localhost:5001/api/servicios/'+num, this.config)
                    ...
                    .catch(
                       ...
                       function(error){
                          console.log(error)
                          axios.delete('https://rapisolverapi.herokuapp.com/api/servicios/'+num, this.config)
                               .then(response=>{
                                  document.getElementById('spinner').style.display ='none'
                                  console.log(response.data)
			...
			await axios.
                delete('https://localhost:5001/api/reservations/'+num, this.config)
                    ...
                    .catch(
                       ...
                       function(error){
                          console.log(error)
                          axios.delete('https://rapisolverapi.herokuapp.com/api/reservations/'+num, this.config)
                                 .then(response=>{
                                    document.getElementById('spinner').style.display ='none'
                                    console.log(response.data)
                                    window.location.href="/miPerfil/"+_this.$route.params.id  
